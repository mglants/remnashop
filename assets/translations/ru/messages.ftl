...
msg-referral-main =
    ...
    • <b>Кол-во уровней</b>: { referral-level }
    • <b>Тип награды</b>: { reward-type }
    • <b>Стратегия начисления</b>: { $accrual_strategy }
    • <b>Стратегия награды</b>: { $reward_strategy }
    </blockquote>
...
msg-referral-accrual-strategy =
    <b>📍 Изменить стратегию начисления</b>

    Выберите в каком случае будет начисляться награда.


msg-referral-reward-strategy =
    <b>⚖️ Изменить стратегию награды</b>

    Выберите как будет распределяться награда.
